...
# Biography of Shengcheng Liu
Nice to meet you Professor Christodoulou. My name is Shengcheng Liu, and you can call me my English name Leo. I was born in China on February 5, 1999. Before the program at **London Business School**, I have spent four years studying at **Shanghai Jiao Tong University**.
...
By the way, I am a big fan of [Lionel Messi](https://en.wikipedia.org/wiki/Lionel_Messi). I am also interested in financial data analytics and I hope to meet you in-person in the *Applied Statistics* course.
...
country_data <- gapminder %>% 
            filter(country == "China") # just choosing China, as this is where I come from
...
```{r lifeExp_one_continent}
 ggplot(continent_data, mapping = aes(x = year, y = lifeExp, color = country, group = country))+
   geom_point() + 
   geom_smooth(se = FALSE) +
   NULL
```
...
The life expectancy in China has been increasing since 1952 as China's economy has been restored gradually and prospered thereafter. As to the life expectancy in all Asian countries, there is an upward trend in general since the Asian world is in peace time after the World War II and science & technology have improved people's life quality in each country.
...
ggplot(brexit_results, aes(x = leave_share)) +
  geom_histogram(binwidth = 2.5) + labs(title = "The Distribution of the Brexit Vote in the UK", subtitle = "2016") + NULL

# density plot-- think smoothed histogram
ggplot(brexit_results, aes(x = leave_share)) +
  geom_density() + labs(title = "Results of the Brexit Vote in the UK", subtitle = "2016") + NULL


# The empirical cumulative distribution function (ECDF) 
ggplot(brexit_results, aes(x = leave_share)) +
  stat_ecdf(geom = "step", pad = FALSE) +
  scale_y_continuous(labels = scales::percent) + labs(title = "The ECDF of the Brexit Vote in the UK", subtitle = "2016", y = "cumulative density") + NULL
...
ggplot(brexit_results, aes(x = born_in_uk, y = leave_share)) +
  ...
  theme_bw() + labs(title = "The Scatterplot between the Correlations of Two Variables", subtitle = "0.5 Correlation", x = "proportion of native UK residents") + NULL
...
From the plots above, we can easily conclude that more than half people in the UK vote agree for the 2016 Brexit. As the last plot indicates, the leave share goes up when the proportion of native UK residents increases in the constituency which is clearly an evidence of the speculation above.
...
In my opinion, the density plot best communicates the variability of the incident_notional_cost. And horses are the most expensive to rescue than others.
...
-   Who did you collaborate with: Myself alone
-   Approximately how much time did you spend on this problem set: 3-4 hours
-   What, if anything, gave you the most trouble: Getting used to R syntax and knitting the RMD file.
